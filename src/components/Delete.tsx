import { deleteTransaction, fetchUserData, TransactionType } from "@/lib/features/userSlice"
...
export default function Delete({setUpdateDeleteTab , setOpenDelete , storeSelectedItem} : DeleteTypes) {
    ...
    const handleDeleteDispatch = async () =>{
        await dispatch(deleteTransaction(storeSelectedItem))
  ...
  return (
    ...
    <div className="bg-white w-[50%] h-[40%] flex flex-col gap-5 justify-center items-center relative">
      ...
      <h1 className="font-sans font-extralight text-xl">Are you sure you want to delete this entry?</h1>
