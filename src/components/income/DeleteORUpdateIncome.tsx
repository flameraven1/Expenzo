...
import UpdateInc from "./UpdateInc";
import DeleteInc from "./DeleteInc";
...
export default function DeleteORUpdateIncome({setUpdateDeleteTab , storeSelectedItem} : TypeForQuestionTab) {
  ...
  return (
    ...
    openUpdate ? <UpdateInc openUpdate={openUpdate} setOpenUpdate={setOpenUpdate} setUpdateDeleteTab={setUpdateDeleteTab} storeSelectedItem={storeSelectedItem}/> : openDelete ? <DeleteInc storeSelectedItem={storeSelectedItem} setOpenDelete={setOpenDelete} setUpdateDeleteTab={setUpdateDeleteTab} /> :
