import { deleteExpense, ExpenseType, fetchUserData} from "@/lib/features/userSlice"
...
export default function DeleteExp({setUpdateDeleteTab , setOpenDelete , storeSelectedItem} : DeleteTypes) {

    const dispatch = useAppDispatch();

    const handleDeleteDispatch = async () =>{
        await dispatch(deleteExpense(storeSelectedItem))
  ...
  return (
    ...
    <div className="bg-white w-[50%] h-[40%] flex flex-col gap-5 justify-center items-center relative">
      ...
      <h1 className="font-sans font-extralight text-xl">Are you sure you want to delete this Expense entry?</h1>
