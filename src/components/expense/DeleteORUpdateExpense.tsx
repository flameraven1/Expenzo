...
export default function DeleteORUpdateExpense({setUpdateDeleteTab , storeSelectedItem} : TypeForQuestionTab) {
  ...
  return (
    ...
    openUpdate ? <UpdateExp openUpdate={openUpdate} setOpenUpdate={setOpenUpdate} setUpdateDeleteTab={setUpdateDeleteTab} storeSelectedItem={storeSelectedItem}/> : openDelete ? <DeleteExp storeSelectedItem={storeSelectedItem} setOpenDelete={setOpenDelete} setUpdateDeleteTab={setUpdateDeleteTab} /> :
